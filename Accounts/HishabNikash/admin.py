...
class TransectionAdmin(admin.ModelAdmin):
    list_display = ('date', 'oilLeft', 'totalOilSale', 'price', 'totalRevenue', 'cashDeposited',
                    'overdue', 'oilType', 'dipReading', 'twoPercent', 'comments', 'validTransection',)
...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ('name', 'phone', 'lastPayment',
                    'totalDue', 'active_customer')
    list_filter = ('name',)
...
class DebitToCustomerAdmin(admin.ModelAdmin):
    list_display = ('date', 'oilQuantity', 'customerID', 'TodayDue',
                    'totalAmountPaid', 'totalAmountDue', 'oilType')
...
class GASTransectionAdmin(admin.ModelAdmin):
    list_display = ('inDate', 'quantity', 'totalSale',
                    'cashDeposited', 'perQubicLiter')
...
class GASLastReadingAdmin(admin.ModelAdmin):
    list_display = ('quantity',)


admin.site.register(GASLastReading, GASLastReadingAdmin)
